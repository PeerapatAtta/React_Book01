...
export default function NavBarRouter() {
  return (
    <BrowserRouter>
      ...
      <div className="text-center m-3">
        <Routes>
          <Route path="/" element={<h3 className="lead">Home</h3>} />
          <Route path="/products" element={<h3 className="lead">Products</h3>} />
          <Route path="/member" element={<h3 className="lead">Member</h3>} />
          <Route path="/contact" element={<h3 className="lead">Contact Us</h3>} />
        </Routes>
      </div>
